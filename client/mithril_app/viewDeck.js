(function(){
  ...
  viewDeck.controller = function(args){
    ...
    viewDeck.noMore = function(){
      ...
      ctrl.back(m('br')) //should be an overtime button.
      m.redraw()
      console.log("noMore ran")
    }

    ctrl.nextCard = function () {
      console.log(ctrl.currentDeck.cards[ctrl.index+1]);
      console.log(ctrl.index);
      //this if condition should also check how many cards have been viewed this day.
